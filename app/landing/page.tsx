...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[10px] text-muted-foreground font-semibold -mt-1">Gestão Inteligente</div>
            </div>
          </div>
          {/* </CHANGE> */}
          <div className="hidden md:flex items-center gap-8">
            <Link href="#modules" className="text-sm font-semibold hover:text-primary transition-colors">
              Módulos
            </Link>
            <Link href="#recursos" className="text-sm font-semibold hover:text-primary transition-colors">
              Recursos
            </Link>
            <Link href="#contato" className="text-sm font-semibold hover:text-primary transition-colors">
              Contato
            </Link>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            <div>
              ...
              <p className="text-xl md:text-2xl text-muted-foreground mb-12 text-balance leading-relaxed font-medium">
                CRM + RPA + Automação em uma única plataforma. Gerencie clientes, contratos, empresas e relatórios com
                inteligência artificial.
              </p>
              <div className="flex flex-wrap items-center gap-4">
                <Button size="lg" className="text-base font-black h-14 px-10 shadow-xl group" asChild>
                  <a href={whatsappLink} target="_blank" rel="noopener noreferrer">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-sm md:text-base text-muted-foreground font-semibold">Empresas ativas</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-black mb-2 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                90%
              </div>
              <div className="text-sm md:text-base text-muted-foreground font-semibold">Redução de tempo</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-black mb-2 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                +30
              </div>
              <div className="text-sm md:text-base text-muted-foreground font-semibold">Bancos integrados</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-black mb-2 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                99.9%
              </div>
              <div className="text-sm md:text-base text-muted-foreground font-semibold">Uptime garantido</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="modules" className="py-24 md:py-36">
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            <Badge className="mb-4 bg-blue-600/10 text-blue-700 border-blue-600/20">Módulos</Badge>
            ...
            <p className="text-xl md:text-2xl text-muted-foreground text-balance max-w-3xl mx-auto leading-relaxed">
              Gestão inteligente de usuários, clientes, empresas, contratos, metas e relatórios
            </p>
          </div>
            ...
            <Card className="p-12 bg-gradient-to-br from-blue-50 to-white dark:from-blue-950/20 dark:to-background border-2">
              <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
                <div>
                  ...
                  <h3 className="text-3xl font-black mb-4">Acompanhe tudo em tempo real</h3>
                  <p className="text-muted-foreground leading-relaxed mb-6">
                    Dashboard completo com métricas essenciais: total de clientes, metas alcançadas, contratos pendentes
                    e comissões do mês. Tudo atualizado em tempo real.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm font-medium">Métricas visuais com indicadores de crescimento</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm font-medium">Contratos recentes com status coloridos</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm font-medium">Alertas inteligentes para ações pendentes</span>
                    </li>
                  </ul>
                </div>
                <div className="relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
            <Card className="p-8 hover:shadow-xl transition-all group">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Controle completo de usuários e permissões. Gerencie sua equipe com níveis de acesso personalizados para
            ...
            <Card className="p-8 hover:shadow-xl transition-all group">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Cadastro completo com dados pessoais, documentos, histórico de propostas e status de contratos.
                Formulário em etapas para facilitar o processo.
              </p>
            </Card>
            ...
            <Card className="p-8 hover:shadow-xl transition-all group">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Gestão de empresas conveniadas com validação automática de CNPJ, endereço completo e informações de
                contato. Pesquisa rápida e organizada.
              </p>
            </Card>
            ...
            <Card className="p-8 hover:shadow-xl transition-all group">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Tabela completa com cliente, valor, parcelas, status e data. Status coloridos (Aprovado, Pendente, Em
                Análise) para visualização rápida.
              </p>
            </Card>
            ...
            <Card className="p-8 hover:shadow-xl transition-all group">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Cards visuais mostrando percentual de metas alcançadas com indicadores de crescimento. Acompanhe o
            ...
            <Card className="p-8 hover:shadow-xl transition-all group">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Relatórios completos e personalizáveis com exportação em Excel, PDF. Visualize comissões, produção e
            ...
            <Card className="p-12 bg-gradient-to-br from-green-50 to-white dark:from-green-950/20 dark:to-background border-2">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 md:order-2">
                  ...
                  <h3 className="text-3xl font-black mb-4">Formulário completo de clientes</h3>
                  <p className="text-muted-foreground leading-relaxed mb-6">
                    Sistema de cadastro em 3 etapas: Dados Cadastrais, Dados Funcionais e Documentos. Interface limpa e
                    intuitiva que guia o usuário pelo processo completo.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm font-medium">Validação de CPF e dados em tempo real</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm font-medium">Busca automática de endereço por CEP</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm font-medium">Upload de documentos com preview</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <Card className="p-12 bg-gradient-to-br from-purple-50 to-white dark:from-purple-950/20 dark:to-background border-2">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <h3 className="text-3xl font-black mb-4">Empresas conveniadas organizadas</h3>
                  <p className="text-muted-foreground leading-relaxed mb-6">
                    Tabela completa com razão social, nome fantasia, CNPJ, endereço completo, telefone e cidade. Sistema
                    de pesquisa e paginação para facilitar a navegação.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm font-medium">Consulta automática de CNPJ na Receita Federal</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm font-medium">Ações rápidas para editar e gerenciar</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm font-medium">Exportação de relatórios de empresas</span>
                    </li>
                  </ul>
                </div>
                <div className="relative">
                  <div className="rounded-2xl overflow-hidden shadow-2xl">
                    <img src="/images/image.png" alt="Gestão de Empresas" className="w-full h-auto" />
                  </div>
                </div>
              </div>
            </Card>
      ...
      <section id="recursos" className="py-24 md:py-36 bg-blue-50 dark:bg-blue-950/10">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto mb-24">
            <div>
              <Badge className="mb-4 bg-primary/10 text-primary border-primary/20">Controle Financeiro</Badge>
              <h2 className="text-4xl md:text-5xl font-black mb-6 tracking-tight">
                Controle de Propostas, Tabelas e Comissões
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                O SIMPLICONSIG também ajuda a organizar a administração da sua empresa de crédito consignado. Com o
                controle financeiro, você acompanha suas comissões pagas pelo banco e gerencia de forma ágil e segura
                suas receitas.
              </p>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-bold mb-1">Contas a Pagar / Contas a Receber</h4>
                    <p className="text-sm text-muted-foreground">
                      Acompanhe suas comissões pagas pelo banco, percentual e datas, gerenciando de forma ágil suas
                      receitas.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-accent mt-0.5 flex-shrink-0" />
                  <div>
                    <h4 className="font-bold mb-1">Bancos, Convênios, Tabelas e Comissões</h4>
                    <p className="text-sm text-muted-foreground">
                      Mobilidade total para atuar como sua empresa trabalha. Seja diretamente com Bancos ou com
                      correspondentes bancários parceiros.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div>
              <img src="/images/image.png" alt="Controle Financeiro" className="rounded-2xl shadow-2xl" />
            </div>
          </div>

          <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            <div className="order-2 md:order-1">
              <img src="/images/image.png" alt="Recursos da Plataforma" className="rounded-2xl shadow-2xl" />
            </div>
            <div className="order-1 md:order-2">
              <Badge className="mb-4 bg-primary/10 text-primary border-primary/20">Recursos Poderosos</Badge>
              <h2 className="text-4xl md:text-5xl font-black mb-6 tracking-tight">Software Para Crédito Consignado</h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                O SIMPLICONSIG é um sistema para crédito consignado desenvolvido exclusivamente para utilização de
                Correspondentes Bancários. Com uma interface dinâmica, intuitiva e um design moderno, faz deste sistema
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center p-6 bg-background rounded-xl">
                  ...
                  <p className="text-xs text-muted-foreground">Monitore atividades através do CRM</p>
                </div>
                <div className="text-center p-6 bg-background rounded-xl">
                  <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-3">
                  ...
                  <p className="text-xs text-muted-foreground">Redução de risco de perda de dados</p>
                </div>
                <div className="text-center p-6 bg-background rounded-xl">
                  <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-3">
                  ...
                  <p className="text-xs text-muted-foreground">Relatórios para tomada de decisões</p>
                </div>
                <div className="text-center p-6 bg-background rounded-xl">
                  <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-3">
                  ...
                  <p className="text-xs text-muted-foreground">Módulos simples e fáceis de operar</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 md:py-36">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <Badge className="mb-4 bg-primary/10 text-primary border-primary/20">RPA e Automação</Badge>
            <h2 className="text-4xl md:text-6xl font-black mb-6 text-balance tracking-tight">
              Automação que economiza 90% do seu tempo
            </h2>
            <p className="text-xl text-muted-foreground text-balance leading-relaxed">
              Robôs inteligentes trabalham 24/7 automatizando tarefas repetitivas enquanto sua equipe foca no que
              realmente importa: vendas e atendimento ao cliente.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="p-8 text-center hover:shadow-xl transition-all">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Robôs consultam automaticamente todos os bancos integrados em segundos, eliminando processos manuais.
              </p>
            </Card>
            ...
            <Card className="p-8 text-center hover:shadow-xl transition-all">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Processe centenas de contratos simultaneamente com validação automática de documentos e dados.
              </p>
            </Card>
            ...
            <Card className="p-8 text-center hover:shadow-xl transition-all">
              ...
              <h3 className="text-xl font-black mb-3">Inteligência Artificial</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                IA analisa padrões e sugere melhores produtos para cada cliente, aumentando taxa de conversão.
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="py-24 bg-blue-50 dark:bg-blue-950/10">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-black mb-4">O que nossos clientes dizem</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="p-8">
              ...
              <p className="text-muted-foreground mb-6 font-medium leading-relaxed">
                "Aumentamos nossa produtividade em 300% no primeiro mês. O RPA sozinho economizou 20h/semana da nossa
                equipe."
              </p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">CEO, FinConsig</div>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-8">
              ...
              <p className="text-muted-foreground mb-6 font-medium leading-relaxed">
                "A integração com os bancos é impecável. Reduzimos erros em 95% e o tempo de processamento caiu pela
                metade."
              </p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Diretora, Crédito Fácil</div>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-8">
              ...
              <p className="text-muted-foreground mb-6 font-medium leading-relaxed">
                "ROI em menos de 2 meses. O suporte é excepcional e a plataforma não trava nunca. Indispensável!"
              </p>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-primary-foreground font-black">
                  RL
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Gerente, Banco Parceiro</div>
                </div>
              </div>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4 relative">
          <Card className="p-12 md:p-20 text-center bg-transparent border-0 shadow-none text-primary-foreground">
            ...
            <p className="text-xl md:text-2xl mb-12 text-primary-foreground/95 text-balance max-w-3xl mx-auto leading-relaxed font-medium">
              Fale com nosso especialista e descubra como o SIMPLICONSIG pode transformar sua operação de crédito
              consignado
            </p>
            <Button
              size="lg"
            ...
            <p className="mt-6 text-primary-foreground/90">
              WhatsApp: (69) 99388-1869 • Resposta imediata • Consultoria gratuita
            </p>
          </Card>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Plataforma completa de gestão para crédito consignado com RPA e automação inteligente.
              </p>
            </div>
            <div>
